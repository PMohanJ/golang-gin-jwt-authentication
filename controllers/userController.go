...
import (
	...
	helper "github.com/pmohanj/golang-jwt-project/helpers"

	"github.com/gin-gonic/gin"
	"github.com/go-playground/validator/v10"
	"github.com/pmohanj/golang-jwt-project/database"
	"github.com/pmohanj/golang-jwt-project/models"
...
func VerifyPassword(userPassowrd string, providedPassword string) (bool, string) {
	err := bcrypt.CompareHashAndPassword([]byte(providedPassword), []byte(userPassowrd))
	check := true
	msg := ""
	if err != nil {
		msg = fmt.Sprintf("email and password is correct")
	}
	return check, msg
}
...
func Singup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if count > 0 {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "this email or phone num is already in use"})
		}
		...
		if insertError != nil {
			msg := fmt.Sprintf("User item was not correct")
